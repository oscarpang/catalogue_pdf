...
//			loadStylesConfiguration(root);
			// if (!Main.getCSSFile().equals("")) loadStyleSheet(new
			// File(Main.getCSSFile()));
		} catch (Exception e) {
...
//						new CSSPropertyConfigItem(replaceSpecialStrings(start), replaceSpecialStrings(end)));
//			}
//		}
//	}
